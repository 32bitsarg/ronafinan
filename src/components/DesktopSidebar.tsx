...
import { LayoutDashboard, PieChart, LineChart, ReceiptText, Wallet, Settings, LogOut, PlusCircle } from 'lucide-react';
...
export default function DesktopSidebar() {
    ...
    const NAV_ITEMS = [
        { label: 'Nuevo Movimiento', href: '/desktop/nuevo', icon: <PlusCircle size={20} color="var(--accent-primary)" /> },
